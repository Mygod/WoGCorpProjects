...
LEVELS_EDITTABLE = set(['island1','island2','island3','island4','island5','IslandUi','MapWorldView'])
#LEVELS_EDITTABLE = set()
LEVELS_READONLY_LOWER=set([level_name.lower() for level_name in LEVELS_ORIGINAL.difference(LEVELS_EDITTABLE)])
...
ELEMENT_BUTTON = describe_element( 'button', groups = 'image', attributes = [
        ...
        scale_attribute( 'scale', init = '1,1', min_value = 0.0000001, mandatory = True,
                         map_to = ('scalex', 'scaley') ),
        reference_attribute( 'up', reference_family = 'image', reference_world = WORLD_LEVEL,  init = '', mandatory = True ),
        reference_attribute( 'over', reference_family = 'image', reference_world = WORLD_LEVEL, allow_empty=True, remove_empty=True ),
        reference_attribute( 'down', reference_family = 'image', reference_world = WORLD_LEVEL, allow_empty=True, remove_empty=True),
        reference_attribute( 'downover', reference_family = 'image', reference_world = WORLD_LEVEL,  allow_empty=True, remove_empty=True ),
        reference_attribute( 'armed', reference_family = 'image', reference_world = WORLD_LEVEL,  allow_empty=True, remove_empty=True ),
        reference_attribute( 'downarmed', reference_family = 'image', reference_world = WORLD_LEVEL, allow_empty=True, remove_empty=True),
        reference_attribute( 'disabled', reference_family = 'image', reference_world = WORLD_LEVEL, allow_empty=True, remove_empty=True ),
        reference_attribute( 'downdisabled', reference_family = 'image', reference_world = WORLD_LEVEL, allow_empty=True, remove_empty=True ),
        bool_attribute( 'latch',allow_empty=True, remove_empty=True  ),
        reference_attribute( 'font', reference_family = 'font', reference_world = WORLD_GLOBAL ,allow_empty=True, remove_empty=True ),
        reference_attribute( 'text', reference_family = 'text', reference_world = WORLD_GLOBAL ,allow_empty=True, remove_empty=True ),

        reference_attribute( 'tooltip', reference_family = 'text', reference_world = WORLD_GLOBAL ,allow_empty=True, remove_empty=True ),
        string_attribute( 'onclick' ,allow_empty=True, remove_empty=True ),
        string_attribute( 'onmouseenter' ,allow_empty=True, remove_empty=True ),
        string_attribute( 'onmouseexit' ,allow_empty=True, remove_empty=True ),

        rgb_attribute( 'colorize', init = '255,255,255',allow_empty=True, remove_empty=True  ),
        argb_attribute( 'textcolorup', allow_empty=True, remove_empty=True ),
        argb_attribute( 'textcolorupover', allow_empty=True, remove_empty=True ),
        argb_attribute( 'textcoloruparmed', allow_empty=True, remove_empty=True ),
        argb_attribute( 'textcolorupdisabled', allow_empty=True, remove_empty=True ),
        argb_attribute( 'textcolordown', allow_empty=True, remove_empty=True ),
        argb_attribute( 'textcolordownover', allow_empty=True, remove_empty=True ),
        argb_attribute( 'textcolordownarmed', allow_empty=True, remove_empty=True ),
        argb_attribute( 'textcolordowndisabled', allow_empty=True, remove_empty=True ),
...
TREE_LEVEL_SCENE.add_elements( [
    describe_element( 'scene', exact_occurrence = 1, groups = 'image', attributes = [
        ...
        describe_element( 'buttongroup', groups = 'image', attributes = [
            string_attribute( 'id', mandatory = True , display_id=True),
        ...
        describe_element( 'linearforcefield', groups = 'physic', attributes = [
            ...
            real_attribute( 'rotationaldampeningfactor', allow_empty=True,remove_empty=True ),
