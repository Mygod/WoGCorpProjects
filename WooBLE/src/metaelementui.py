...
ATTRIBUTE_NAME_EDITOR_HANDLERS = {
    ...
    'state': { 'editor': complete_list,
             'listdialog': complete_enumerated_property  },
    'part': { 'editor': complete_list,
             'listdialog': complete_world_reference_property  },
    'sounds': { 'editor': complete_list,
             'listdialog': complete_global_reference_property  }
    #'spawn': { 'completer': complete_ball_names_property  }
