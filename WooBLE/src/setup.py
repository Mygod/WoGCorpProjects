"""
 py2app/py2exe build script for WooBLE (Ball Editor)
...
if sys.platform=='win32':
    ...
    import py2exe
    setup( console=[{ "script": "wooble.py" ,
                      "icon_resources": [(1,'images/wooble.ico')]}] ,
    ...
    OPTIONS = {'argv_emulation': True,
           ...
           'iconfile': 'images/wooble.icns',
           'resources': 'files.xml.xml',
           'plist': {'CFBundleDisplayName': 'WooBLE'}
           }
    setup(  app=APP,
