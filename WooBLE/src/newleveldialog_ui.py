...
class Ui_NewLevelDialog(object):
    ...
    def retranslateUi(self, NewLevelDialog):
        NewLevelDialog.setWindowTitle(QtGui.QApplication.translate("NewLevelDialog", "Create New Ball", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("NewLevelDialog", "&New Ball name:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("NewLevelDialog", "(Letters, Numbers and _    Must begin with a letter)", None, QtGui.QApplication.UnicodeUTF8))
