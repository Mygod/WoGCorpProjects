...
ERROR_URL = 'http://goofans.com/developers/world-of-goo-ball-editor/reference-guide/errors-and-warnings#%d'
...
#Scene Tree Errors
    ...
    6:[ISSUE_LEVEL_WARNING,'<tt>%s</tt> has no children.'],
    ...
    12:[ISSUE_LEVEL_ADVICE,'Scenelayer <tt>%s</tt> has non-uniform scaling and animation'],
    13:[ISSUE_LEVEL_CRITICAL,'<tt>%s</tt> is non-static and total mass is 0'],
#Level Tree Errors
...
#Dependancy Errors and Notifications
    ...
    308:[ISSUE_LEVEL_ADVICE,'Custom Animations used <tt>%s</tt>'],
...
#Ball Tree Errors
    ...
    514:[ISSUE_LEVEL_ADVICE,'<b><tt>throw</tt></b> sound not last in list. <b><tt>%s</tt></b> sounds will play instead'],
    515:[ISSUE_LEVEL_ADVICE,'<b><tt>throw</tt></b> sound not found. <b><tt>%s</tt></b> sounds will play instead'],
    516:[ISSUE_LEVEL_CRITICAL,'Ball is <tt>static</tt> and <tt>draggable</tt>'],
    517:[ISSUE_LEVEL_CRITICAL,'Strand is <tt>rigid</tt> but strand mass is 0'],
    518:[ISSUE_LEVEL_ADVICE,'Ball is a MOM and <tt>static</tt>, it cannot be popped'],
    519:[ISSUE_LEVEL_ADVICE,'Ball is a MOM and has strands, it will not pop when attached'],
    520:[ISSUE_LEVEL_ADVICE,'Ball is a MOM and <tt>sticky</tt>, it cannot be popped'],
    521:[ISSUE_LEVEL_CRITICAL,'Ball set to <tt>autoattach</tt>, but has no <tt>strand</tt> defined']
}
