...
class Ui_EditLevelDialog(object):
    ...
    def retranslateUi(self, EditLevelDialog):
        EditLevelDialog.setWindowTitle(QtGui.QApplication.translate("EditLevelDialog", "Select movie to edit...", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("EditLevelDialog", "Select move to edit:", None, QtGui.QApplication.UnicodeUTF8))
