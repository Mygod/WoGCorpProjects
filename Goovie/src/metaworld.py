...
MOVIE_EXE_TEXT=['SIGN_TEXT',
               'SIGN_TEXT1','SIGN_TEXT2',
               'SEASON_TEXT',
               'STAT_TIME','STAT_MOVES','STAT_EXTRACREDIT','STAT_COLLECTED','STAT_GOAL',
               'LEVEL_TEXT','LEVEL_NAME']

MOVIE_EXE_IMAGE=['$ISLAND_ICON']
...
class Element(_ElementBase):
    ...
    def make_child( self, element_meta, attributes = None, children = None, insert_index=None ):
        ...
        if insert_index is None:
            ...
            self.insert( insert_index, child_element )
