...
class Ui_NewLevelDialog(object):
    ...
    def retranslateUi(self, NewLevelDialog):
        NewLevelDialog.setWindowTitle(QtGui.QApplication.translate("NewLevelDialog", "Create New Movie", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("NewLevelDialog", "&New movie name (directory name):", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("NewLevelDialog", "(Letters and Numbers only)", None, QtGui.QApplication.UnicodeUTF8))
