...
{
    public partial class ProfilePropertiesWindow
    {
        public ProfilePropertiesWindow(Profile p)
        {
            DataContext = p;
            InitializeComponent();
            CountryCodeBox.ItemsSource = CountryCodes;
        }
        ...
        private static readonly string[] CountryCodes =
        {
            ...
            "DJ", "DK", "DM", "DO", "EC", "EE", "EG", "EH", "ER", "ES", "ET", "EU", "FI", "FJ", "FK", "FM", "FO", "FR",
